...
const ProfileScreen = ({ location, history }) => {
  ...
  return (
    <Row>
      <Col md={3}>
        <h1 className="font-weight-bold text-white">User Profile</h1>
      ...
      <Col md={9}>
        ...
        {loadingOrders ? (
          ...
          <Table striped bordered hover responsive className="table-sm table-custom">
            <thead>
              <tr>
                <th>ID</th>
                <th>DATE</th>
                ...
                <tr key={order._id}>
                  ...
                  <td>
                    <LinkContainer to={`/order/${order._id}`}>
                      <Button className='button-light-custom border-0'>Details</Button>
                    </LinkContainer>
                  </td>
                </tr>
              ))}
